    ...
    <div class="hero-foot">
      <nav class="tabs is-centered">
        <div class="container">
          <ul>
            <li>
              <a href="https://gitlab.com/jjocram" target="_blank"
                >GitLab&ensp;<font-awesome-icon icon="fa-brands fa-gitlab"
              /></a>
            </li>
            <li>
              <a href="https://github.com/jjocram" target="_blank"
                >GitHub&ensp;<font-awesome-icon icon="fa-brands fa-github"
              /></a>
            </li>
            <li>
              <a
                href="https://www.linkedin.com/in/marco-ferrati-347346118/"
                target="_blank"
                >LinkedIn&ensp;<font-awesome-icon icon="fa-brands fa-linkedin"
              /></a>
            </li>
            <li>
              <a href="https://twitter.com/FerratiMarco" target="_blank"
